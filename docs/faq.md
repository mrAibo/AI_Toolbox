...
### rtk is not found
Install Rust first (`curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs | sh`), then run `cargo install rtk`. After installation, run `rtk init -g` to install hooks for your AI client.
